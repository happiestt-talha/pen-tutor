                ...
                <div className="text-center mb-8">
                    <div className="flex items-center justify-center mb-4">
                        <div className="flex items-center space-x-2">
                            {/* <div className="w-8 h-8 bg-[#313D6A] rounded flex items-center justify-center">
                                <span className="text-white font-bold text-sm">PT</span>
                            </div>
                            <span className="text-xl font-bold text-gray-800">PEN TUTOR</span> */}
                            <Image src="/logo.png" className="w-40" alt="Pen Tutor logo" width={160} height={60} />
                        </div>
                    </div>
                    <p className="text-gray-600 text-2xl">Register Yourself</p>
                </div>
                            ...
                            <CardHeader className="pb-4">
                                ...
                                <Tabs value={activeTab} onValueChange={handleTabChange}>
                                    <TabsList className="grid w-full grid-cols-2">
                                        ...
                                        <TabsTrigger
                                            value="tutor"
                                            className="data-[state=active]:bg-[#313D6A] data-[state=active]:text-white text-xs"
                                        >
                                            Tutor
                                        </TabsTrigger>
                                    </TabsList>
                    ...
                    <CardHeader className="pb-4">
                        ...
                        {/* <div className="flex items-center justify-center mt-8 space-x-6">
                            ...
                            <Button
                                ...
                                className={`px-8 py-2 rounded-lg text-white font-semibold ${activeTab === "students" ? "bg-yellow-500 hover:bg-yellow-600" : "bg-[#313D6A] hover:bg-[#313D6A]"
